...
class _MoreclientState extends State<Moreclient> {
  final MoreClientController moreClientController = Get.put(
      MoreClientController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() =>
      moreClientController.isLoading.value
          ...
          return RefreshIndicator(
            ...
            backgroundColor: Colors.white,
              ...
              onRefresh: ()  async{
                  ...
                  moreClientController.isLoading.value = true;
                  await moreClientController.refreshData();
                  moreClientController.isLoading.value = false;
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            ...
                            backgroundImage: moreClientController.profile_pic
                                .value == '' ||
                                moreClientController.profile_pic.value.isEmpty
                                || moreClientController.profile_pic.value ==
