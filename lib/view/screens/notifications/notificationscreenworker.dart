...
class NotificationsPageworker extends StatefulWidget {
  @override
  _NotificationsPageworkerState createState() => _NotificationsPageworkerState();
}
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        ...
                        Get.to(bidDetailsWorker(projectId: notification.id ?? 0)):
                        notification.type=='postproject'&&  usertype=='client'?
                        Get.to(bidDetailsClient(projectId:notification.id??0)):
                        notification.type=='postproject'&&  usertype=='worker'?
                        Get.to(bidDetailsWorker(projectId: notification.id??0)):
